...
namespace Directus.Generated
{
    ...
    /// No comment.
    /// </summary>
    [GeneratedRecord("settings_assets_observer")]
    public partial class @SettingsAssetsObserverRecord : DbRecord, IDbRecord    { // start of generated class

        public static explicit operator SettingsAssetsObserverRecord(long id) => DbRecordUtil.CreateRef<SettingsAssetsObserverRecord>(id);
        public static explicit operator SettingsAssetsObserverRecord(string id) => DbRecordUtil.CreateRef<SettingsAssetsObserverRecord>(id);
        ...
        /// <code>
        /// {        ///   "collection": "settings_assets_observer",        ///   "field": "id",        ///   "hidden": true,        ///   "id": 285,        ///   "interface": "datetime",        ///   "note": null,        ///   "options": null,        ///   "readonly": false,        ///   "sort": 0,        ///   "special": null,        ///   "system": false,        ///   "translation": null,        ///   "width": "full"        /// }
        /// </code></para>
        /// </remarks>
        ...
        [JsonIgnore] public string __Table => "settings_assets_observer";
        [JsonIgnore] public static Type __TypeOfSelf => typeof(SettingsAssetsObserverRecord);
