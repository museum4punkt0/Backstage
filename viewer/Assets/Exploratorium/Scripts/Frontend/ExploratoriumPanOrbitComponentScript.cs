...
namespace Exploratorium.Frontend
{
    ...
    /// </summary>
    [AddComponentMenu("Fingers Gestures/Component/Exploratorium Pan Orbit", 2)]
    public class ExploratoriumPanOrbitComponentScript : MonoBehaviour
    {
        [Tooltip("Only detect the gesture while on the mask object")]
        ...
        [Tooltip("Whether the pan and rotate orbit gestures must start on the mask object to orbit. The tap gesture always requires that it be on the mask object.")]
        public bool RequireGesturesToStartOnMaskObject;
        ...
        private void OnEnable()
        {
            ...
            TapGesture.PlatformSpecificView = MaskObject.gameObject;

            if (RequireGesturesToStartOnMaskObject)
            {
                ScaleGesture.PlatformSpecificView = MaskObject.gameObject;
                PanGesture.PlatformSpecificView = MaskObject.gameObject;
            }
