...
{
    /// <summary>
    /// This class provides some additional context for the connection managed by the <see cref="NetworkPortalClient"/>. If a disconnect occurs, or is expected to occur, client
    ...
    public class DisconnectReason
    {
        ...
        public void SetDisconnectReason(ConnectStatus reason)
        {
            ...
            Debug.Log($"Disconnect reason is {reason}");
            Reason = reason;
        }
